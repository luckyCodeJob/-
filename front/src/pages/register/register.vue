<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221024/23b37078fa41495b866fda764fd3ea28.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>日常办公用品直售推荐系统的设计与实现注册</p></div>
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='yonghu'" prop="lianxifangshi">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="shangjiamingcheng">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="mima">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="shangjiatupian">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="lianxiren">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="lianxidianhua">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="jingyingfanwei">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="shangjiadizhi">
